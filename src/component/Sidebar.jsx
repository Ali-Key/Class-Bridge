...
export const Sidebar = () => {
  return (
    <>
    <div className="lg:w-[15%] fixed top-0 bottom-0 left-0 p-3 bg-[#000] text-[#fff] font-mono ">
      <div className="flex flex-col justify-start items-center space-y-16 mt-4">
        ...
        <ul className="flex flex-col justify-start items-start space-y-6">
          ...
          <li className="flex flex-row justify-start items-start  space-x-3"><GiClassicalKnowledge className="inline" size={20}/> <Link to="/EditClass">EditClass</Link></li>
